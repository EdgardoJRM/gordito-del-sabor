    ...
    <main className="min-h-screen bg-[#FAF8F5]">
      <section className="bg-[#FAF8F5] border-b border-[#E8E0D8] py-8">
        <div className="container-custom">
          ...
          <h1 className="heading-section text-[#1A1412] mb-6">Política de Privacidad</h1>
          <p className="body-text text-[#9C8B80]">Última actualización: {new Date().toLocaleDateString('es-PR')}</p>
        </div>
      </section>
      ...
      <section className="section-spacing">
        <div className="container-custom max-w-3xl">
          <div className="body-text space-y-8">
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">1. Responsable del tratamiento</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">2. Datos que recogemos</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">3. Uso de los datos</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">4. Cookies y tecnologías similares</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">5. Tus derechos</h2>
              <p>Puedes solicitar acceso, rectificación, supresión o portabilidad de tus datos, o limitar su tratamiento, contactándonos a <a href="mailto:info@gorditodelsabor.com" className="text-[#C4472B] font-semibold hover:underline">info@gorditodelsabor.com</a>. Si consideras que el tratamiento no es correcto, tienes derecho a presentar una reclamación ante la autoridad de protección de datos que corresponda.</p>
            </div>
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">6. Contacto</h2>
              <p>Para cualquier duda sobre esta política: <a href="mailto:info@gorditodelsabor.com" className="text-[#C4472B] font-semibold hover:underline">info@gorditodelsabor.com</a>.</p>
            </div>
          </div>
        </div>
      </section>
