    ...
    <main className="min-h-screen bg-[#FAF8F5]">
      <section className="bg-[#FAF8F5] border-b border-[#E8E0D8] py-8">
        <div className="container-custom">
          ...
          <h1 className="heading-section text-[#1A1412] mb-6">Términos y Condiciones</h1>
      ...
      <section className="section-spacing">
        <div className="container-custom max-w-3xl">
          <div className="body-text space-y-8">
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">1. Aceptación</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">2. Uso del Sitio</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">3. Contenido y propiedad intelectual</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">4. Cuenta y registro</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">5. Compras y pagos</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">6. Limitación de responsabilidad</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">7. Modificaciones</h2>
            ...
            <div>
              <h2 className="text-[#1A1412] font-bold text-lg mb-2">8. Contacto</h2>
              <p>Para dudas sobre estos términos: <a href="mailto:info@gorditodelsabor.com" className="text-[#C4472B] font-semibold hover:underline">info@gorditodelsabor.com</a>.</p>
            </div>
          </div>
        </div>
      </section>
